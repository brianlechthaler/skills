...
| Skill | Description |
|-------|-------------|
| [opencode-setup](../../opencode-setup/SKILL.md) | Configure OpenCode with a specified provider and model, writing opencode.json and .env.example with a placeholder API key the user must fill in. |
